  ...
  <span class="max-w-[66rem] p-[0.5rem] w-full m-auto">
    ...
    <span class="flex flex-col p-[1rem] max-w-[66rem] w-full m-auto gap-[1rem]">
      <span class="flex gap-[1rem] items-center">
        ...
        <div class="hidden lg:flex h-[0.1rem] w-[100vw] max-w-[10rem] bg-[#C778DD]" />
      </span>

      <span class="flex items-center justify-between gap-[1rem]">
        <span
          class=" items-center flex-wrap w-full md:flex-row lg:flex-row flex gap-[1rem]"
        >
          ...
          <span class="flex flex-col max-w-[15rem]">
            ...
            <div
              class="px-[1rem] py-[0.3rem] text-[#ABB2BF] border-[#ABB2BF] border-solid border"
            >
              Sveltekit, Next, Remix, Solid, Astro, Django, Laravel
            </div>
          </span>
        </span>
      </span>
    ...
    <span class="flex flex-col p-[1rem] max-w-[66rem] w-full m-auto gap-[1rem]">
      <span class="flex gap-[1rem] items-center">
        ...
        <div class="hidden lg:flex h-[0.1rem] w-[100vw] max-w-[20rem] bg-[#C778DD]" />
      </span>
